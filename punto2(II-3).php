...
<html lang="en">
    ...
    <body class="d-flex flex-column h-100">
        <main class="flex-shrink-0">
            ...
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">PUNTO 2</h1>
        ...
        <form method='post' action=''>
            ...
            <span class="input-group-text" id="basic-addon3">Ingrese puntos acumulados </span>
            <input type="number" class="form-control" name="puntos" aria-describedby="basic-addon3 basic-addon4" required><br><br>
